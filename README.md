[AI Web Scraper](https://apify.com/nexgendata/ai-web-scraper?fpr=data)
...
```
curl -X POST "https://api.apify.com/v2/acts/nexgendata~ai-web-scraper/run-sync-get-dataset-items?token=YOUR_TOKEN" \
